...
### Changed
- Consolidated CLI into single file with subcommands (removed get_issue.py, sprint_status.py)
- Restructured repository for marketplace format (plugins/jira-connector/)
- Renamed command wrapper to test skill auto-discovery

### Added
- Comprehensive plugin development guide (docs/plugin-development.md)
- Detailed jira-connector documentation (plugins/jira-connector/docs/jira-connector.md)
